...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/01/15 13:12:23 by pnovato-          #+#    #+#             */
/*   Updated: 2026/01/15 13:16:17 by pnovato-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		exec_command_node(t_node *node, t_shell *sh, int *last_exit,
			int in_child);
...
void	run_heredoc_child(t_node *node, t_shell *sh, int *pipe_fd,
			int last_exit);
