...
//essa estrutura é necessária pq vamos ter que ter o
//nosso proprio ambiente de execução.
//No subject tem umas built-ins:"unset,export"
//que se usarmos na envp[] normal, ela não executa
//pq não podemos modificar diretamente esse array
//(char **envp), quando precisamos modificar
